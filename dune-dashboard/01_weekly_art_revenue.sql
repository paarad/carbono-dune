...
, all_art_sales AS (
    -- ===== NFT.TRADES (all marketplaces) =====

    -- Genesis
    SELECT block_time, tx_hash, amount_original as sales,
        ...
        cast(number_of_items as integer) as quantity,
        CASE WHEN seller IN (0x000a837ddd815bcba0fa91a98a50aa7a3fa62c9c, 0x8c9f364bf7a56ed058fc63ef81c6cf09c833e656)
    ...
    UNION ALL
    -- Fragmentation
    SELECT block_time, tx_hash, amount_original,
        CASE WHEN seller IN (0x000a837ddd815bcba0fa91a98a50aa7a3fa62c9c, 0x8c9f364bf7a56ed058fc63ef81c6cf09c833e656)
    ...
    UNION ALL
    -- ===== BATCH OFFER SALES (SuperRare BatchOfferCreator) =====
...
SELECT
    ...
    , array_agg(a.tx_hash) as tx_hashes
